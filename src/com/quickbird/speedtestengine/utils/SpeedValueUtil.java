...
public class SpeedValueUtil {
	...
	public static String getSpeedWideBroad(int speed) {
		float speed_float = speed / 8;
		if (speed_float > 1281)
			return "20M";
		if (speed_float > 1025)
			return "10M";
	...
	public static int getSpeedWideBroadLevel(int speed) {
		float speed_float = speed / 1024;
		if (speed_float > 1281)
			return 7;
		if (speed_float > 1025)
			return 6;
