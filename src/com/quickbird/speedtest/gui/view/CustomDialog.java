    ...
    public static class Builder {
        ...
        public CustomDialog create() {
            ...
            if (positiveButtonText != null) {
                ((Button) layout.findViewById(R.id.positiveAlertBtn))
                ...
                layout.findViewById(R.id.positiveAlertBtn).setVisibility(
                        View.GONE);
            }
            // set the cancel button
            if (negativeButtonText != null) {
                ((Button) layout.findViewById(R.id.negativeAlertBtn))
                ...
                // if no confirm button just set the visibility to GONE
                layout.findViewById(R.id.negativeAlertBtn).setVisibility(
                        View.GONE);
            }
